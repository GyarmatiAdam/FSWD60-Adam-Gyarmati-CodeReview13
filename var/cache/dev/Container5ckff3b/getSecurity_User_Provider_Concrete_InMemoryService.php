...
return $this->services['security.user.provider.concrete.in_memory'] = new \Symfony\Component\Security\Core\User\InMemoryUserProvider(['admin' => ['password' => '$2y$13$WanHR7S2smiQlW.XQqfbru/NFsxvlp2wk2ZGaOsBO1RWizQDxNV3G', 'roles' => [0 => 'ROLE_ADMIN']]]);
