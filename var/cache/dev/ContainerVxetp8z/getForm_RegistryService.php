...
return $this->services['form.registry'] = new \Symfony\Component\Form\FormRegistry([0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(['AppBundle\\Form\\Type\\MemberType' => function () {
    return ${($_ = isset($this->services['AppBundle\\Form\\Type\\MemberType']) ? $this->services['AppBundle\\Form\\Type\\MemberType'] : ($this->services['AppBundle\\Form\\Type\\MemberType'] = new \AppBundle\Form\Type\MemberType())) && false ?: '_'};
